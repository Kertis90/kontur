...
try{
 ...
 console.log('0.21 MySQL: оценки, согласование состава, цикл связей, карта без записи, отзыв доступа, избранное, перенос связей и повтор сохранения ИИ — проверены.');
