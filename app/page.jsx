  ...
  return <div className="shell has-companion">
    <aside className="sidebar">
      ...
      <div className="sidebar-projects">
        <div className="sidebar-section-label">Избранные проекты</div>
    ...
    <main className="main">
      ...
      <div className="content">
        ...
        {view === "board" && project && <BoardView project={project} workflow={workflow} tasks={tasks} data={data} onOpen={setTaskDraft} onNew={openNewTask} onMoved={(taskId,stageId)=>applyTaskChange(data.tasks.find(t=>t.id===taskId),{stage_id:stageId})}/>}
...
function BoardView({ project, workflow, tasks, data, onOpen, onNew, onMoved }) {
