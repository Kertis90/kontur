...
export const AGENT_NODE_LABELS={analyze:'Анализ моделью',action:'Действие',approval:'Согласование сотрудника',condition:'Условие',filter:'Фильтр источников',template:'Собрать текст',stop:'Завершить сценарий'};
